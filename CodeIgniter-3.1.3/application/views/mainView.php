							...
							<div  class="w3-modal-content w3-animate-top w3-card-4">
								...
								<div id="id02" class="w3-container w3-text-black ">
									<div class="w3-container">
										...
										<form name="frmTest" action="NextPage.php" method="POST">
											<p>
											<select name="ComboName" onChange="frmTest.submit();">
												<option value="en" name="en" href="www.ualg.pt">English</option>
												<option value="pt" name="pt" href="www.ualg.pt">Português</option>
											</select>
										</form>
										<!--END COMBOBOX-->
										...
										<div class="w3-container">
											...
											<p>This site shows modelled level of underwater noise generated by large shipping traffic - the so called shipping noise. 
												Shipping is one of many ways to introduce man made noise into the marine environment.</p>
											<p>
											<h3>Why did you create this site?</h3>
											<p>Our objective is to show the contribution of shipping to the antropogenic (man made) underwater noise level, 
												which is a chronic form of polluting our oceans today. Underwater noise has been the topic of various studies 
												with respect to the effects on marine life. This site does by no way show actual in-situ measurements. 
												Data is obtained from an underwater acoustic model, however due to the notorious dificulty in performing actual 
												measurements it can be used as an aproximation.</p>
											<p>
