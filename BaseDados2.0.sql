...
CREATE TABLE `superficie` (
  ...
  `percentil` varchar(20) DEFAULT 'map',
...
INSERT INTO `superficie` VALUES (1,'2000-01-01 00:00:00','portugal','www.imagem1','map'),(2,'2000-01-01 00:00:00','espanha','www.imagem2','map'),(3,'2001-01-01 00:00:00','espanha','www3','map');
...
INSERT INTO `zona` VALUES ('espanha',34,34),('inglaterra',22,21),('portugal',12,12);
...
-- Dump completed on 2017-04-29 14:32:25
